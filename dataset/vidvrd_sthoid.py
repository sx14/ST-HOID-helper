...
class VidVRD_STHOID(Dataset):
    ...
    def __init__(self, anno_rpath, video_rpath, splits):
        ...
        """
        super(VidVRD_STHOID, self).__init__(anno_rpath, video_rpath, splits)
        print('VidVRD-STHOID dataset loaded.')
...
if __name__ == '__main__':
    ...
    parser.add_argument('data_root', type=str, default='../data/vidvrd_sthoid',
    ...
    dataset = VidVRD_STHOID(anno_root, video_root, ['train', 'test'])
    ...
    output_path = 'vidvrd_sthoid_%s_%s_gt.json' % (args.task, args.split)
